...
public class CreateSubPhysicalExamPageCase1 extends EditingMainPage1 {
   ...
   /* ModalWindow parentSelection;
    ...
    public CreateSubPhysicalExamPageCase1(int index) {
        groupID=index;
...
*/
            ...
            Phsica.setGroupId(groupID);
            physicalExamEntityDao.save(Phsica);
            info("You have created a new sub-Physical Exam successfully");
/*
