...
public class SearchInterveiwTreePanel3 extends Panel {
    @SpringBean
    ...
    public SearchInterveiwTreePanel3(String id, final String Search) {
        super(id);
                            ...
                            if (model.getObject().getFeedbackInput() != null) {
                                ...
                                if (model.getObject().getFeedbackInput().contains("3F")) {
                                    ...
                                    if (model.getObject().getFeedbackInput().contains("3F+1"))
                                        ...
                                        getSession().setAttribute("3F", (Integer) getSession().getAttribute("3F+2") + 2);
