...
public class LabAndImageTreePageCase2 extends AbstractTreePage {
    @SpringBean
 ...
 */
    public LabAndImageTreePageCase2(int index) {
        //  super(id);
                ...
                if (getProvider().hasChildren(model.getObject()))
                    ...
                    return new LabAndImageEntityFolder(id, this, model) {
                        ...
                        public void clicked(AjaxRequestTarget target) {
                            ...
                            modal.setContent(new EditingexistingLabAndImagePanel("content", model.getObject()));
                            modal.show(target);
