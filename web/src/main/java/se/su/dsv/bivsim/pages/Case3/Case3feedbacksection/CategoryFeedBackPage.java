 ...
 */
public class CategoryFeedBackPage extends BaseFeedbackPageCase3 {
    ...
    public CategoryFeedBackPage() {
        ...
        Link PreliminärBedömning = new AjaxFallbackLink("PreliminärBedömning") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                setResponsePage(se.su.dsv.bivsim.pages.Case3.Case3feedbacksection.PreliminärBedömning.class);
            }
        };
        this.add(PreliminärBedömning);

        // save log module
        new SaveLogCase("Case3log");
