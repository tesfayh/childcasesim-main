...
public class PhysicalExamTreePageCase2 extends AbstractTreePage {
 ...
 */
    public PhysicalExamTreePageCase2(int index) {
        //  super(id);
                ...
                if (getProvider().hasChildren(model.getObject()))
                    ...
                    return new PhysicalExamEntityFolder(id, this, model) {
                        ...
                        public void clicked(AjaxRequestTarget target) {
                            ...
                            modal.setContent(new EditingexistingPhysicalExamPanel("content", model.getObject()));
                            modal.show(target);
