...
public class InterviewEntityProvider implements ITreeProvider<InterviewEntity> {
   ...
   String  tempType;
    ...
    public InterviewEntityProvider(InterviewEntityDao interviewEntityDao, final Integer groupId, final String type) {
    ...
    public Iterator<InterviewEntity> getRoots() {
        ...
        return interviewEntityDao.findAllEntityWithOutParents(tempGroupID, tempType).iterator();
    }
