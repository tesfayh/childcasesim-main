...
import se.su.dsv.bivsim.pages.Case1.CommonCase1.BaseClasses.BasePagephysical;
import se.su.dsv.bivsim.pages.Case1.physicalexa.PhysicalExamTreePanel;

public class HeaderPanelPhysical extends Panel {


    public HeaderPanelPhysical(String id) {
        super(id);

        Link Inspection = new AjaxFallbackLink("Inspection") {
            @Override
            public void onClick(AjaxRequestTarget target) {
                ((BasePagephysical) getPage()).getContentW().replace(new PhysicalExamTreePanel("mainNavigation2", 1));
                target.add(((BasePagephysical) getPage()).getContentW());
            }
...
// it was 10
        ...
        Link Palpation = new AjaxFallbackLink("Palpation") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                ((BasePagephysical) getPage()).getContentW().replace(new PhysicalExamTreePanel("mainNavigation2", 2));
                target.add(((BasePagephysical) getPage()).getContentW());
        ...
        Link Auscultation = new AjaxFallbackLink("Auscultation") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                ((BasePagephysical) getPage()).getContentW().replace(new PhysicalExamTreePanel("mainNavigation2", 3));
                target.add(((BasePagephysical) getPage()).getContentW());
        ...
        Link Psykstatus = new AjaxFallbackLink("Psykstatus") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                ((BasePagephysical) getPage()).getContentW().replace(new PhysicalExamTreePanel("mainNavigation2", 4));
                target.add(((BasePagephysical) getPage()).getContentW());
            }
        };
        this.add(Psykstatus);
        ...
        Link Övrigt = new AjaxFallbackLink("Övrigt") {
            ...
            @Override
            public void onClick(AjaxRequestTarget target) {
                ((BasePagephysical) getPage()).getContentW().replace(new PhysicalExamTreePanel("mainNavigation2", 5));
                target.add(((BasePagephysical) getPage()).getContentW());
