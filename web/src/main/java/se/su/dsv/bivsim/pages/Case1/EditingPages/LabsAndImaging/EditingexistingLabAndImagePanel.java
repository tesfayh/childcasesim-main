...
public class EditingexistingLabAndImagePanel extends Panel {
    ...
    public EditingexistingLabAndImagePanel(String id, final ImagingEntity entity) {
        super(id);
        ...
        AjaxLink<String> close = new AjaxLink<String>("close") {
            @Override
            public void onClick(AjaxRequestTarget target) {
                setResponsePage(LabAndImageTreePageCase1.class);
                flag = 0;
