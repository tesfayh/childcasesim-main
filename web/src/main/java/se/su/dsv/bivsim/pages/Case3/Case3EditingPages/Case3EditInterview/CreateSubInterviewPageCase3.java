...
public class CreateSubInterviewPageCase3 extends EditingMainPage3 {
    ...
    public CreateSubInterviewPageCase3(int index, String type) {
...
*/
        ...
        parentSelection.setContent(new SelectInterviewEntityParentPanel("content", index, type) {
            @Override
            public void okay() {
                CreateSubInterviewPageCase3.this.selectedParent = this.getSelectedParent();
