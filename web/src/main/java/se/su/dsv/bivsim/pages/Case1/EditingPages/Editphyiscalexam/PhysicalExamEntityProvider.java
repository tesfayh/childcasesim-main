...
public class PhysicalExamEntityProvider implements ITreeProvider<PhysicalExamEntity> {
    ...
    public PhysicalExamEntityProvider(PhysicalExamEntityDao physicalExamEntityDao, int index) {
    ...
    public Iterator<PhysicalExamEntity> getRoots() {
        return physicalExamEntityDao.findAllEntityWithOutParents(tempo).iterator();
    }
