...
public class VirtualPatientEditingPageCase2 extends EditingMainPage2 {
    ModalWindow modal;
    @SpringBean
    FeedbackEntityDao feedbackEntityDao;

    public VirtualPatientEditingPageCase2() {
        ...
        add(new AjaxLink<String>("edit_link") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(1), "Öppningsfras  >="));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("edit_link1") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(2), "Respekt > ="));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("edit_link2") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(3), "Öppna frågor >="));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("edit_link3") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(4), "3F >="));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("edit_link4") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(5), "Spegling > ="));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("edit_link5") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(6), "Empati > = "));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("edit_link6") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(7), "Relevans >= "));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("edit_link7") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(8), "Tillit > ="));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("edit_link8") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(9), "Antal frågor < "));
                modal.show(target);
            }
        });
...
// Postive feedback editing code
        ...
        add(new AjaxLink<String>("nedit_link") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(10), " Öppningsfras < = "));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("nedit_link1") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(11), "Respekt < "));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("nedit_link2") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(12), "Öppna frågor < "));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("nedit_link3") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(13), "3F <"));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("nedit_link4") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(14), "Spegling <"));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("nedit_link5") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(15), "Empati < "));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("nedit_link5r") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(16), "Relevans  <"));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("nedit_link6") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(17), "Tillit  < ="));
                modal.show(target);
            }
        });
        ...
        add(new AjaxLink<String>("nedit_link7") {
            ...
            public void onClick(AjaxRequestTarget target) {
                target.prependJavaScript("Wicket.Window.unloadConfirmation = false;");
                modal.setContent(new VirtualPatientEntityPanel2("content", feedbackEntityDao.findObject(18), "Antal frågor >"));
                modal.show(target);
            }
        });
