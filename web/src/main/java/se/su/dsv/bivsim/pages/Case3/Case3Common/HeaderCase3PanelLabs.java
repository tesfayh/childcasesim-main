...
import se.su.dsv.bivsim.pages.Case3.Case3Imaging.ImagingTreePanel;
    ...
    public HeaderCase3PanelLabs(String id) {
        ...
        Link KlinKemi = new AjaxFallbackLink("KlinKemi") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ((BaseLabsCase3Page) getPage()).getContentW().replace(new ImagingTreePanel("mainNavigation2", 9));
                target.add(((BaseLabsCase3Page) getPage()).getContentW());
            }
        ...
        Link Mikrobiologi = new AjaxFallbackLink("Mikrobiologi") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                ((BaseLabsCase3Page) getPage()).getContentW().replace(new ImagingTreePanel("mainNavigation2", 10));
                target.add(((BaseLabsCase3Page) getPage()).getContentW());
        ...
        Link Fysiologi = new AjaxFallbackLink("Fysiologi") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                ((BaseLabsCase3Page) getPage()).getContentW().replace(new ImagingTreePanel("mainNavigation2", 11));
                target.add(((BaseLabsCase3Page) getPage()).getContentW());
        ...
        Link Rtg = new AjaxFallbackLink("Bild/Rtg") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                ((BaseLabsCase3Page) getPage()).getContentW().replace(new ImagingTreePanel("mainNavigation2", 12));
                target.add(((BaseLabsCase3Page) getPage()).getContentW());
