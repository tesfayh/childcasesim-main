 ...
 */
public class VideoResourceReference3 extends ResourceReference {

    public VideoResourceReference3() {
        super(VideoResourceReference3.class, "VideoReference");
    }
    ...
    private static class VideoResource extends DynamicImageResource {
        ...
        private byte[] getImageAsBytes(String label) {
            try {
                File file = new File("/var/childcasesim/VideoclipsCase3/" + label);
