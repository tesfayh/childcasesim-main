...
import se.su.dsv.bivsim.pages.Case3.Case3Screeninginstruments.*;
 ...
 */
public class BaseInstrumentCase3Page extends WebPage {
    ...
    public BaseInstrumentCase3Page(final PageParameters parameters) {
