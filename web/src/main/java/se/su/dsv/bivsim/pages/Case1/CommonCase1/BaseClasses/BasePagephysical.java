...
import se.su.dsv.bivsim.pages.Case1.physicalexa.StatusNonTreePanel;
import se.su.dsv.bivsim.pages.CommonAllCases.*;

public class BasePagephysical extends WebPage {
    ...
    public BasePagephysical(IModel model) {
        super(model);
