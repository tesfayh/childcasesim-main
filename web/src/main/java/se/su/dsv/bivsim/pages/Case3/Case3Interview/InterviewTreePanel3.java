...
import se.su.dsv.childcasesim.pages.CommonAllCases.Interv.InterviewEntityProvider;
import se.su.dsv.childcasesim.pages.CommonAllCases.Interv.InterviewFolder;

public class InterviewTreePanel3 extends Panel {
    @SpringBean
    ...
    public InterviewTreePanel3(String id, final Integer groupId) {
        super(id);
        add(new DefaultNestedTree<InterviewEntity>("tree", new InterviewEntityProvider(interviewEntityDao, groupId)) {
            @Override
                    ...
                    return new InterviewFolder(id, this, model) {
                        ...
                        public void clicked(AjaxRequestTarget target) {
                            ...
                            if (model.getObject().getClipId() != null && !model.getObject().getClipId().contains("pic")) {
                                panel = new VideoPanel("content", model.getObject().getPatientAnswer(), model.getObject().getClipId(), new VideoResourceReference3());
                                ...
                                panel = new InterviewPicturePanel("content", model.getObject().getPatientAnswer(), model.getObject().getClipId(), new VideoResourceReference3());
                            ...
                            if (model.getObject().getExp_feedbackInput() != null) {
                                ...
                                if (model.getObject().getExp_feedbackInput().contains("Öppnafrågor")) {
                                    ...
                                    if (model.getObject().getExp_feedbackInput().contains("Öppnafrågor+1"))
                                        getSession().setAttribute("exÖppnafrågor", (Integer) getSession().getAttribute("exÖppnafrågor") + 1);
                                    else if (model.getObject().getExp_feedbackInput().contains("Öppnafrågor+2"))
                                        getSession().setAttribute("exÖppnafrågor", (Integer) getSession().getAttribute("exÖppnafrågor") + 2);
                                    else if (model.getObject().getExp_feedbackInput().contains("Öppnafrågor-1"))
                                        getSession().setAttribute("exÖppnafrågor", (Integer) getSession().getAttribute("exÖppnafrågor") - 1);
                                    else
                                ...
                                if (model.getObject().getExp_feedbackInput().contains("Funktionsnivå")) {
                                    ...
                                    if (model.getObject().getExp_feedbackInput().contains("Funktionsnivå+1"))
                                        getSession().setAttribute("exFunktionsnivå", (Integer) getSession().getAttribute("exFunktionsnivå") + 1);
                                    else if (model.getObject().getExp_feedbackInput().contains("Funktionsnivå+2"))
                                        getSession().setAttribute("exFunktionsnivå", (Integer) getSession().getAttribute("exFunktionsnivå") + 2);
                                    else if (model.getObject().getExp_feedbackInput().contains("Funktionsnivå-1"))
                                        getSession().setAttribute("exFunktionsnivå", (Integer) getSession().getAttribute("exFunktionsnivå") - 1);
                                    else
                                        getSession().setAttribute("exFunktionsnivå", (Integer) getSession().getAttribute("exFunktionsnivå") - 2);
