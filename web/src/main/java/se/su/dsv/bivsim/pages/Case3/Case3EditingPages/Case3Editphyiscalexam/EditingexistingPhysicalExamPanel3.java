...
public class EditingexistingPhysicalExamPanel3 extends Panel {
    ...
    public EditingexistingPhysicalExamPanel3(String id, final PhysicalExamEntity entity) {
        super(id);
        ...
        AjaxLink<String> close = new AjaxLink<String>("close") {
            @Override
            public void onClick(AjaxRequestTarget target) {
                setResponsePage(PhysicalExamTreePageCase3.class);
                flag = 0;
