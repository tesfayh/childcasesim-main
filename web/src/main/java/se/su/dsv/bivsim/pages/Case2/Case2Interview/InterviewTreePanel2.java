...
public class InterviewTreePanel2 extends Panel {
    @SpringBean
    ...
    public void setContent(Panel panel, AjaxRequestTarget target) {
        ((HomeCase2Page) getPage()).getContentWmc().replace(panel);
        target.add(((HomeCase2Page) getPage()).getContentWmc());
    }

    public InterviewTreePanel2(String id, final Integer groupId) {
        super(id);
                    ...
                    return new InterviewFolder(id, this, model) {
                        ...
                        public void clicked(AjaxRequestTarget target) {
                            ...
                            if (model.getObject().getClipId() != null && model.getObject().getPatientAnswer() != null && !model.getObject().getClipId().contains("pic")) {
                                panel = new VideoPanel("content", model.getObject().getPatientAnswer(), model.getObject().getClipId(), new VideoResourceReference2());
