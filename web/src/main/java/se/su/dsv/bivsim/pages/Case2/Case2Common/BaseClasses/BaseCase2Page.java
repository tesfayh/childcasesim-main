...
import se.su.dsv.childcasesim.pages.Case2.Case2Interview.InterviewTreePanel2;
import se.su.dsv.childcasesim.pages.Case2.Case2Interview.SearchInterveiwTreePanel2;
...
*/
        ...
        AjaxSubmitLink addLink = new AjaxSubmitLink("link") {
            ...
            protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                if (searchtxt.getModel().getObject() != null) {
                    SearchContainer1.replace(new SearchInterveiwTreePanel2("subSearch", searchtxt.getModel().getObject().toString()));
        ...
        Link Interview = new AjaxFallbackLink("Introduction") {
            @Override
            public void onClick(AjaxRequestTarget target) {
                QuestionContainer1.replace(new InterviewTreePanel2("subQuestion1", 10));
                target.add((QuestionContainer1));
                ...
                ((BaseCase2Page) getPage()).getContentSearch().replace(new EmptyPanel("subSearch"));
                target.add(((BaseCase2Page) getPage()).getContentSearch());
        ...
        Link physicalExam = new AjaxFallbackLink("Aktuellt") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                QuestionContainer2.replace(new InterviewTreePanel2("subQuestion2", 11));
                target.add((QuestionContainer2));
        ...
        Link labsImaging = new AjaxFallbackLink("Tidigare") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                QuestionContainer3.replace(new InterviewTreePanel2("subQuestion3", 12));
                target.add((QuestionContainer3));
        ...
        Link screeingInstruments = new AjaxFallbackLink("Socialt") {
            ...
            @Override
            public void onClick(AjaxRequestTarget target) {
                QuestionContainer4.replace(new InterviewTreePanel2("subQuestion4", 13));
                target.add((QuestionContainer4));
        ...
        Link Hereditet = new AjaxFallbackLink("Hereditet") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                QuestionContainer5.replace(new InterviewTreePanel2("subQuestion5", 14));
                target.add((QuestionContainer5));
                // setting to empty panel
                QuestionContainer1.replace(new EmptyPanel("subQuestion1"));
                target.add((QuestionContainer1));
        ...
        Link Allergier = new AjaxFallbackLink("Allergier") {
            ...
            @Override
            public void onClick(AjaxRequestTarget target) {
                QuestionContainer6.replace(new InterviewTreePanel2("subQuestion6", 15));
                target.add((QuestionContainer6));
                // setting to empty panel
                QuestionContainer1.replace(new EmptyPanel("subQuestion1"));
                target.add((QuestionContainer1));
        ...
        Link Medicinering = new AjaxFallbackLink("Medicinering") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                QuestionContainer7.replace(new InterviewTreePanel2("subQuestion7", 16));
                target.add((QuestionContainer7));
        ...
        Link Levnadsvanor = new AjaxFallbackLink("Levnadsvanor") {
            ...
            @Override
            public void onClick(AjaxRequestTarget target) {
                QuestionContainer8.replace(new InterviewTreePanel2("subQuestion8", 17));
                target.add((QuestionContainer8));
