...
import se.su.dsv.bivsim.pages.Case2.Case2Screeninginstruments.SocialPanel;
 ...
 */
public class InstrumentCase2ListPage extends WebPage {
    ModalWindow modal;
    int panelnumber;
    PageParameters pageParameters;

    public InstrumentCase2ListPage() {
        ...
        Link PHQ9 = new AjaxFallbackLink("PHQ9") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                setResponsePage(BaseInstrumentCase2Page.class, pageParameters);
            }
    ...
    public InstrumentCase2ListPage(IModel model) {
        super(model);
