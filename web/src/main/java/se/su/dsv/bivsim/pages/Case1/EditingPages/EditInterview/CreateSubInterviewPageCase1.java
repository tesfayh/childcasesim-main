...
public class CreateSubInterviewPageCase1 extends EditingMainPage1 {
    ...
    public CreateSubInterviewPageCase1(int index, String type) {
...
*/
        ...
        parentSelection.setContent(new SelectInterviewEntityParentPanel("content", index, type) {
            @Override
            public void okay() {
                CreateSubInterviewPageCase1.this.selectedParent = this.getSelectedParent();
...
*/
            ...
            info("Du har skapat en ny under intervju");
