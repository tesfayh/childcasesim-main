...
import se.su.dsv.bivsim.pages.Case1.interview.SimplePanel;


public class InterviewTreePageCase1 extends AbstractTreePage {
 ...
 */
    public InterviewTreePageCase1(int index, String type) {
        //  super(id);
