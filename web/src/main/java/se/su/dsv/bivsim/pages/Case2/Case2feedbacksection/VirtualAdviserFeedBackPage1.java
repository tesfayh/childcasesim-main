...
public class VirtualAdviserFeedBackPage1 extends BaseFeedbackPageCase2 {
    @SpringBean
    ...
    public VirtualAdviserFeedBackPage1() {
        ...
        List<VirtualAdviserEntity> adviser_list = virtualAdviserEntityDao.findAllByGroupId(2);
