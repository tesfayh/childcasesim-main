...
public class SaveLogCase2 extends WebPage {
    ...
    public SaveLogCase2(String Caselog) {
        ...
        try {
            ...
            File file = new File("/var/childcasesim/" + "Case2log/" + getSession().getAttribute("username").toString() + "(" + dateFormat.format(date) + ")" + ".txt");
