...
@Table(name = "InterviewCase2", schema = "", catalog = "bivsim")
@Entity
public class InterviewCase2Entity extends DomainObject implements Serializable {


    public InterviewCase2Entity() {
    ...
    private InterviewCase2Entity parent;

    @OneToMany(mappedBy = "parent", cascade = {CascadeType.ALL}, fetch = FetchType.LAZY)
    private List<InterviewCase2Entity> interviews = new ArrayList<InterviewCase2Entity>();
    ...
    public InterviewCase2Entity getParent() {
        return parent;
    }

    public void setParent(InterviewCase2Entity parent) {
        this.parent = parent;
        // parent.getInterviews().add(this);
    }

    public List<InterviewCase2Entity> getInterviews() {
        return interviews;
    }

    public void setInterviews(List<InterviewCase2Entity> interviews) {
        this.interviews = interviews;
    }

    public List<InterviewCase2Entity> getInterviewEntity() {
    ...
    public boolean equals(Object o) {
        ...
        InterviewCase2Entity that = (InterviewCase2Entity) o;
