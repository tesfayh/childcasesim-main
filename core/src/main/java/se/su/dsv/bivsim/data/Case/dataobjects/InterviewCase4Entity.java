 ...
 */
@Table(name = "InterviewCase4", schema = "", catalog = "bivsim")
@Entity
public class InterviewCase4Entity extends DomainObject implements Serializable {

    public InterviewCase4Entity() {
    ...
    private InterviewCase4Entity parent;

    @OneToMany(mappedBy = "parent", cascade = {CascadeType.ALL}, fetch = FetchType.LAZY)
    private List<InterviewCase4Entity> interviews = new ArrayList<InterviewCase4Entity>();
    ...
    public InterviewCase4Entity getParent() {
        return parent;
    }

    public void setParent(InterviewCase4Entity parent) {
        this.parent = parent;
        // parent.getInterviews().add(this);
    }

    public List<InterviewCase4Entity> getInterviews() {
        return interviews;
    }

    public void setInterviews(List<InterviewCase4Entity> interviews) {
        this.interviews = interviews;
    }

    public List<InterviewCase4Entity> getInterviewEntity() {
    ...
    public boolean equals(Object o) {
        ...
        InterviewCase4Entity that = (InterviewCase4Entity) o;
