 ...
 */
@Table(name = "InterviewCase3", schema = "", catalog = "bivsim")
@Entity
public class InterviewCase3Entity extends DomainObject implements Serializable {

    public InterviewCase3Entity() {
    ...
    private InterviewCase3Entity parent;

    @OneToMany(mappedBy = "parent", cascade = {CascadeType.ALL}, fetch = FetchType.LAZY)
    private List<InterviewCase3Entity> interviews = new ArrayList<InterviewCase3Entity>();
    ...
    public InterviewCase3Entity getParent() {
        return parent;
    }

    public void setParent(InterviewCase3Entity parent) {
        this.parent = parent;
        // parent.getInterviews().add(this);
    }

    public List<InterviewCase3Entity> getInterviews() {
        return interviews;
    }

    public void setInterviews(List<InterviewCase3Entity> interviews) {
        this.interviews = interviews;
    }

    public List<InterviewCase3Entity> getInterviewEntity() {
    ...
    public boolean equals(Object o) {
        ...
        InterviewCase3Entity that = (InterviewCase3Entity) o;
