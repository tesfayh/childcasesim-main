...
@Table(name = "PHQ2", schema = "", catalog = "bivsim")

@Entity
public class Phq2Entity extends DomainObject implements Serializable {
    ...
    public long getPhq2Id() {
        return phq2Id;
    }

    public void setPhq2Id(int phq2Id) {
        this.phq2Id = phq2Id;
    }
    ...
    public boolean equals(Object o) {
        ...
        Phq2Entity that = (Phq2Entity) o;

        if (phq2Id != that.phq2Id) return false;
